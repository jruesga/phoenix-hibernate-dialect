...
```xml
    <dependencies>
        ...
        <dependency>
            ...
            <version>0.0.4-hibernate4</version>
        </dependency>
        ...
    </dependencies>
```
